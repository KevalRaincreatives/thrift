  ...
  Future sendVerificationEmail()  async{
    try {
      ...
      DynamicLinkParameters(
        ...
        link: Uri.parse(
            'https://casuarinathrift.page.link/emailVerify?mode=verifyEmail'),
        androidParameters:
...
// toast(prefs.getString('login_email').toString().trim());
      await auth
          .sendSignInLinkToEmail(
        email: prefs.getString('login_email').toString().trim(),
        actionCodeSettings:
        ActionCodeSettings(
          url: dynamicUrl.toString(),
          handleCodeInApp: true,
          iOSBundleId: 'com.rc.cassie',
          androidPackageName: 'com.rc.thrift',
          androidInstallApp: true,
          // androidMinimumVersion: '12',
        ),
      )
          .catchError((onError) => toast(
