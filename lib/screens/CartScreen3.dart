...
//      print
      ...
      Response response = await get(
          Uri.parse('https://thriftapp.rcstaging.co.in/wp-json/wooapp/v3/get_shipping_methods?country_code=TT'),
          headers: headers);
      // EasyLoading.dismiss();
      print('Response status2: ${response.statusCode}');
      print('Response body2: ${response.body}');
...
//      print
  ...
  Widget build(BuildContext context) {
    ...
    CartPrice(int pos) {
      ...
      return text(currency! + myprice+" JMD",
          ...
          onTap: () async {
            if(_addressModel!.data!.length == 0){
             toast("Please Add Shipping Address");
              ...
              prefs.setString('shipment_title',
                  newShipmentModel!.methods![selectedShipingIndex]!.id!.toString());
              prefs.setString('shipment_method',
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      text(
                          _addressModel!.data![0]!.firstName! +
                              " " +
                              _addressModel!.data![0]!.lastName!,
                          textColor: sh_textColorPrimary,
                          fontFamily: fontMedium,
                          fontSize: textSizeSMedium),
                      text(_addressModel!.data![0]!.address!,
                          textColor: sh_textColorPrimary,
                          fontSize: textSizeSMedium),
                      text(
                          _addressModel!.data![0]!.city! +
                              "," +
                              _addressModel!.data![0]!.state!,
                          textColor: sh_textColorPrimary,
                          fontSize: textSizeSMedium),
                      text(
                          _addressModel!.data![0]!.country! +
                              "," +
                              _addressModel!.data![0]!.postcode!,
                          textColor: sh_textColorPrimary,
                          fontSize: textSizeSMedium),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                Text("Delivery",style: TextStyle(color: sh_colorPrimary2,fontSize: 16,fontFamily: "Bold"),),
                                  Row(
                                    children: [
                                      Text("No",style: TextStyle(color: sh_colorPrimary2,fontSize: 16,fontFamily: "Bold"),),
                                      Switch(
                                        value: isSwitched,
                                        onChanged: (value) {
                                          setState(() {
                                      ...
                                      Text("Yes",style: TextStyle(color: sh_colorPrimary2,fontSize: 16,fontFamily: "Bold"),),
                                    ],
                                  )
                                ],
                              ),
                                    ...
                                    if (snapshot.hasData) {
                                      return Container(
                                        child: ListView.builder(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: <Widget>[
                                                      Radio(
                                                          value: index,
                                                          groupValue: selectedShipingIndex,
                                                          onChanged: (int? value) {
                                                            setState(() {
                                                              selectedShipingIndex = value!;
                                                            });
                                                          },
                                                          activeColor: sh_colorPrimary2),
                                                      Expanded(
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            Row(
                                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                              children: [
                                                                Text(newShipmentModel!.methods![index]!.title!,style: TextStyle(color: sh_colorPrimary2,fontSize: 15,fontFamily: "Bold"),),
                                                                Text("\$"+newShipmentModel!.methods![index]!.settings!.cost!.value!+".00",style: TextStyle(color: sh_black,fontSize: 15,fontFamily: "Bold"),)
                                                              ],
                                                            ),
                                                            SizedBox(height: 4,),
                                                            Text(newShipmentModel!.methods![index]!.methodTitle!,style: TextStyle(color: sh_black,fontSize: 13,fontFamily: "Regular"),)
                                          ...
                                          shrinkWrap: true,
                                          itemCount: newShipmentModel!.methods!.length,
                                        ),
                                      );
