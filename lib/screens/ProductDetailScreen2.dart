...
//           "${Url.BASE_URL}wp-json/wc/v3/products/?category=$cat_id"));
//
...
//           Uri.parse(
//               '${Url.BASE_URL}wp-json/wooapp/v3/woocart'),
//           headers: headers);
//
//       print('Response status2: ${response.statusCode}');
...
//                                             } else {
//                                               print(
//                                                   '${Url.BASE_URL}wp-json/wooapp/v3/get_product_variation_id/?product_id=$pro_id' +
//                                                       mygsss);
//                                               fetchVariant(
//                                                   '${Url.BASE_URL}wp-json/wooapp/v3/get_product_variation_id/?product_id=$pro_id' +
//                                                       mygsss);
