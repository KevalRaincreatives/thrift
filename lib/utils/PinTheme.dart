...
class PinTheme {
  ...
  const PinTheme.defaults({
    ...
    this.activeColor = sh_colorPrimary2,
    this.selectedColor = sh_colorPrimary2,
    this.inactiveColor = sh_colorPrimary2,
    this.disabledColor = Colors.grey,
    this.activeFillColor = Colors.green,
    this.selectedFillColor = sh_colorPrimary2,
    this.inactiveFillColor = sh_colorPrimary2,
    this.errorBorderColor = sh_colorPrimary2,
  });
