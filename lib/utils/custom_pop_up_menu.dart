...
class _MenuLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    _MenuPosition menuPosition = _MenuPosition.bottomLeft;
    ...
    if (anchorCenterX - contentSize.width / 2 < 0) {
      ...
      menuPosition = isTop ? _MenuPosition.topRight : _MenuPosition.bottomLeft;
    } else {
      menuPosition =
      isTop ? _MenuPosition.topCenter : _MenuPosition.bottomLeft;
    }
