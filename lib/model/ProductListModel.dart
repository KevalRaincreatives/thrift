...
///
class ProductListModelLinksCollection {
/*
{
...
*/
  ...
  ProductListModelLinksCollection({
    this.href,
  });
  ProductListModelLinksCollection.fromJson(Map<String, dynamic> json) {
...
class ProductListModelLinksSelf {
/*
{
...
*/
  ...
  ProductListModelLinksSelf({
    this.href,
  });
  ProductListModelLinksSelf.fromJson(Map<String, dynamic> json) {
    href = json["href"]?.toString();
  }
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
...
*/
  ...
  List<ProductListModelLinksSelf?>? self;
  List<ProductListModelLinksCollection?>? collection;

  ProductListModelLinks({
    this.self,
    this.collection,
  });
  ProductListModelLinks.fromJson(Map<String, dynamic> json) {
    if (json["self"] != null) {
      final v = json["self"];
      final arr0 = <ProductListModelLinksSelf>[];
      v.forEach((v) {
        arr0.add(ProductListModelLinksSelf.fromJson(v));
      });
      self = arr0;
    }
    if (json["collection"] != null) {
      final v = json["collection"];
      final arr0 = <ProductListModelLinksCollection>[];
      v.forEach((v) {
        arr0.add(ProductListModelLinksCollection.fromJson(v));
      });
      collection = arr0;
    }
  }
...
class ProductListModelMetaData {
/*
{
  "id": 1060724,
  "key": "eancode",
...
*/
  ...
  ProductListModelMetaData({
    this.id,
    this.key,
    this.value,
  });
  ProductListModelMetaData.fromJson(Map<String, dynamic> json) {
    id = json["id"]?.toInt();
...
class ProductListModelDimensions {
/*
{
  "length": "",
  "width": "",
...
*/
  ...
  ProductListModelDimensions({
    this.length,
    this.width,
    this.height,
  });
  ProductListModelDimensions.fromJson(Map<String, dynamic> json) {
...
*/
  ...
  String? weight;
  ProductListModelDimensions? dimensions;
  ...
  ProductListModel.fromJson(Map<dynamic, dynamic> json) {
    ...
    dimensions = (json["dimensions"] != null) ? ProductListModelDimensions.fromJson(json["dimensions"]) : null;
    ...
    final arr0 = <ProductListModelCategories>[];
    v.forEach((v) {
    arr0.add(ProductListModelCategories.fromJson(v));
    });
    categories = arr0;
    }
    if (json["images"] != null) {
    ...
    final arr0 = <ProductListModelMetaData>[];
    v.forEach((v) {
    arr0.add(ProductListModelMetaData.fromJson(v));
    });
    metaData = arr0;
    }
