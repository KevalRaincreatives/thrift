...
class ProductDetailModelMetaDataArray {
/*
{
  "id": 1060724,
  "key": "eancode",
...
*/
  ...
  ProductDetailModelMetaDataArray({
    this.key,
    this.value,
  });
  ProductDetailModelMetaDataArray.fromJson(Map<String, dynamic> json) {
...
*/
  ...
  String? key;
  // String? value;
  // List<ProductDetailModelMetaDataArray?>? value;
  dynamic? value;
  ...
  ProductDetailModelMetaData.fromJson(Map<String, dynamic> json) {
    ...
    if(value.runtimeType==String){
      ...
      // final arr0 = [''];
      // final v = json["value"];
      // final arr0 = <ProductDetailModelMetaDataArray>[];
      // arr0.add(new ProductDetailModelMetaDataArray());
      // value = arr0;
    }else {
      if (json["value"] != null) {

        final v = json["value"];
        print("leather"+v.runtimeType.toString());
        if(v.runtimeType==String){
         value = json["value"]?.toString();
        }else if(v.runtimeType.toString()=="_InternalLinkedHashMap<String, dynamic>"){
          value = "";

        }else {
          final arr0 = <ProductDetailModelMetaDataArray>[];
          v.forEach((v) {
            arr0.add(ProductDetailModelMetaDataArray.fromJson(v));
          });
          value = arr0;
        }
      }
